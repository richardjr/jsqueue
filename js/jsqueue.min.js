...
a)?(void 0!==a.target?b(a.target).append(core.data.htmlinject(b(a.template).html())):b(this).append(core.data.htmlinject(b(a.template).html())),b(this).contents().unwrap(),d(this)):console.log(this)};document.registerElement("wf-template",{prototype:g});g=Object.create(HTMLElement.prototype);g.attachedCallback=function(){var a=b(this).data();if(core.data.check_params({file:{message:"No file specified"}},a)){var c=this;b.ajax({url:a.file,success:function(a){b(c).html(a);b(c).contents().unwrap()},async:!1});
d(this)}else console.log(this)};document.registerElement("wf-include",{prototype:g});g=Object.create(HTMLElement.prototype);g.attachedCallback=function(){var a=b(this).data();if(core.data.check_params({statement:{message:"No statement specified"},template:{message:"No template specified"}},a)){var c=core.data.process_statment(a.statement);a.debug&&console.info(c);eval(c)?(b(this).append(core.data.htmlinject(b(a.template).html())),b(this).contents().unwrap()):a.elsetemplate?(b(this).append(core.data.htmlinject(b(a.elsetemplate).html())),
b(this).contents().unwrap()):b(this).remove();d(this)}else console.log(this)};document.registerElement("wf-if",{prototype:g});g=Object.create(HTMLElement.prototype);g.attachedCallback=function(){var a=b(this).data();if(core.data.check_params({source:{message:"No source specified"}},a)){var c=core.data.uritodata(a.source),e=this;b("wf-case",e).each(function(){var a=b(this).data();a.value==c&&(b(e).html(core.data.htmlinject(b(a.template).html())),b("wf-default",e).remove());b(this).remove()});a=b("wf-default",
e);if(0<a.length){var f=a.data();b(e).html(core.data.htmlinject(b(f.template).html()));a.remove()}b(e).contents().unwrap();d(this)}else console.log(this)};document.registerElement("wf-switch",{prototype:g});g=Object.create(HTMLElement.prototype);g.attachedCallback=function(){var a=b(this).data();if(core.data.check_params({source:{message:"No source specified"},template:{message:"No template specified"}},a)){var c=a.index||"index",e=core.data.uritodata(a.source),f=a.target||this;if(0>=b(f).length)console.error("Target does not exist:"+
a.target);else{jsqueue.loops[c]=0;if("[object Array]"===Object.prototype.toString.call(e))for(var g=0;g<e.length;g++)jsqueue.loops[c]=g,a.stackname&&jsqueue.push_name(a.stackname,e[g]),b(f).append(core.data.htmlinject(b(a.template).html())),d(f);else for(g in e)jsqueue.loops[c]=g,a.stackname&&jsqueue.push_name(a.stackname,{key:g,value:e[g]}),b(f).append(core.data.htmlinject(b(a.template).html())),d(f);a.target?b(this).remove():b(this).contents().unwrap()}}else console.log(this)};document.registerElement("wf-for",
