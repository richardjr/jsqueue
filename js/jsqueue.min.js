...
a)){var c=a.index||"index",e=core.data.uritodata(a.source),f=a.target||this;if(0>=b(f).length)console.error("Target does not exist:"+a.target);else{jsqueue.loops[c]=0;if("[object Array]"===Object.prototype.toString.call(e))for(var g=0;g<e.length;g++)jsqueue.loops[c]=g,a.stackname&&jsqueue.push_name(a.stackname,e[g]),b(f).append(core.data.htmlinject(b(a.template).html())),d(f);else for(g in e)jsqueue.loops[c]=g,a.stackname&&jsqueue.push_name(a.stackname,{key:g,value:e[g]}),b(f).append(core.data.htmlinject(b(a.template).html())),
